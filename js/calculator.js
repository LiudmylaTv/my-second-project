...
function calculateSum() {
  ...
  const websiteCart = document.querySelector('#calculator-form-input-card input:checked');
  ...
  const technologiesValue = getTehnologiesSum(technologiesMultiSelect.getValue());
  const websiteCartValue = convertCardOptionToPrice(websiteCart.value);
...
function getTehnologiesSum(technologiesArr) {
  let totalSum = 0;
